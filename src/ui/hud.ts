...
export class Hud {
  ...
  constructor() {
    ...
    this.hintText = new Text({ text: "WASD move · mouse aim · click fire · Shift dash · Esc pause · swim into the ◈ portal to go deeper", style: mono(12, 0x7a9ab8) });
    this.hintText.style.dropShadow = { alpha: 0.85, angle: Math.PI / 2, blur: 2, color: 0x04070f, distance: 2 };
